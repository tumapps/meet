...
class Generator extends \yii\gii\Generator
{
    ...
    public function generate()
    {
        ...
        $routerFile = Yii::getAlias('@' .(explode('\\',$this->controllerClass))[0].'/routers/'. ucwords($this->getControllerID()) . 'Router.php');

        $files[] = new CodeFile($routerFile, $this->render('router.php'));
    ...
    public function generateRequiredRules($col=null)
    {
        $table = $this->getTableSchema();
        foreach ($table->columns as $column) {
