        ...
        <b-card-body>
          <b-form id="form-wizard1" class="text-center mt-3">
            <ul id="top-tab-list" class="p-0 row list-inline">
              <li :class="['col-lg-3', 'col-md-6', 'mb-3', 'text-start', currentindex == 1 ? 'active' : '', currentindex > 1 ? 'done active' : '']" id="account">
              ...
              <li :class="['col-lg-3', 'col-md-6', 'mb-3', 'text-start', currentindex == 2 ? 'active' : '', currentindex > 1 ? 'done active' : '']" id="personal">
                <a href="javascript:void(0);">
                  <div class="iq-icon me-3">
                    <!-- SVG Icon -->
              ...
              <li :class="['col-lg-3', 'col-md-6', 'mb-3', 'text-start', currentindex == 3 ? 'active' : '', currentindex > 3 ? 'done' : '']" id="confirm">
                <a href="javascript:void(0);">
                  <div class="iq-icon me-3">
                    <!-- SVG Icon -->
            ...
            <div :class="currentindex == 1 ? 'show' : 'd-none'">
              <account-component @onClick="changeTab" :accountData="formData" @updateAccountData="updateAccountData"></account-component>
            </div>

            <div :class="currentindex == 2 ? 'show' : 'd-none'">
              <personal-component @onClick="changeTab" :personalData="formData" @updatePersonalData="updatePersonalData" @Submit="submitForm"></personal-component>
            </div>
