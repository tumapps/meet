...
const openModal = async (id) => {
    try {
        const response = await axiosInstance.get(`v1/auth/role/${id}`);
        RoleDetails.value = response.data.dataPayload.data;
        showModal();
    } catch (error) {
        console.error(error);
    }
...
<template>
    ...
    <!-- //add new role modal -->
    <b-modal ref="AddRole" title="Add Role" class="my-modal taller-modal modal-fullscreen" no-close-on-esc size="xl"
        hide-footer centered hide-header-close="false">
        <template #modal-header="{ close }">
            <!-- Custom header with title and close button -->
            <h5 class="modal-title">Add Role</h5>
            <b-button variant="light" @click="close" class="close">
                &times;
            </b-button>
        </template>
        ...
        <b-row>
            <b-col md="12" lg="6">
                <div class="mb-3">
                    ...
                    <b-form-input v-model="RoleDetails.name" id="startDatePicker" type="text"
                        placeholder="Enter Role Name"></b-form-input>
                </div>
            ...
            <b-col md="12" lg="6">
                <div class="mb-3">
                    ...
                    <b-form-input v-model="RoleDetails.data" id="roledata" type="text"
                        placeholder="Enter Role data"></b-form-input>
                </div>
        ...
        <b-row>
            <b-col md="12" lg="6">
                <div class="mb-3">
                    ...
                    <b-form-input v-model="RoleDetails.description" id="roledescription" type="text"
            ...
            <b-col md="12" lg="6">
                <div class="mb-3">
                    ...
                    <b-form-input v-model="RoleDetails.ruleName" id="rolerulename" type="text"
                        placeholder="Enter Role data"></b-form-input>
                </div>
