                            ...
                            <div class="row">
                                <b-row>
                                    <b-col md="12" lg="6" class="form-group">
                                        ...
                                        <input v-model="username" type="text" class="form-control" id="uname" placeholder="User Name" />
                                ...
                                <b-col md="6" class="form-group">
                                    ...
                                    <div v-if="errors.confirm_password" class="error" aria-live="polite">{{ errors.confirm_password
                                        }}</div>
                                </b-col>
                            </div>
                            <hr />
                            <h5 class="mb-3">New User Information</h5>
                            <b-row>
                                <b-col md="6" class="form-group">
