...
<template>
    ...
    <b-modal ref="newSpace" title="Add Event" class="modal-fullscreen my-modal" no-close-on-backdrop no-close-on-esc
        size="xl" hide-footer>
        <b-row>
            <b-col md="12">
                <div class="mb-3">
        ...
        <b-row>
            <b-col md="12">
                <div class="mb-3">
                    ...
                    <flat-pickr v-model="eventDetails.start_date" class="form-control" :config="config"
                        id="startDatePicker" />
                </div>
            ...
            <b-col md="12">
                <div class="mb-3">
                    ...
                    <flat-pickr v-model="eventDetails.event_date" class="form-control" :config="config"
                        id="startDatePicker" />
                </div>
        ...
        <b-row>
            <b-col md="6">
                <div class="mb-3">
                    ...
                    <flat-pickr v-model="eventDetails.start_time" class="form-control" :config="config2"
                        id="startTimePicker" />
                </div>
            ...
            <b-col md="5">
                <div class="mb-3">
                    ...
                    <flat-pickr v-model="eventDetails.end_time" class="form-control" :config="config2"
                        id="endTimePicker" />
                </div>
    ...
    <b-modal ref="editevent" title="Edit Event" class="modal-fullscreen my-modal" no-close-on-backdrop no-close-on-esc
        size="xl" hide-footer>
        <b-row>
            <b-col md="12">
                <div class="mb-3">
