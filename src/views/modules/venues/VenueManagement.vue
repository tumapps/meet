...
const toggleLock = async (id) => {
    ...
    try {
        ...
        const errorMessage = error?.response?.data?.errorPayload?.errors?.message || errorPayload.message ||'An unknown error occurred';
...
<template>
                    ...
                    <tbody>
                        <template v-if="Array.isArray(tableData) && tableData.length > 0">
                            <tr v-for="(item, index) in sortedData" :key="index">
                                ...
                                <td>{{ item.level_id }}</td>
                                <td>
                                    <button :class="['btn', item.is_locked ? 'btn-danger' : 'btn-success']"
    ...
    <!-- //modal -->
    <b-modal ref="newSpace" title="New Space" class="modal-fullscreen my-modal" no-close-on-backdrop no-close-on-esc
        size="xl" hide-footer>
        <b-row>
            <b-col md="12">
                <div class="mb-3">
        ...
        <b-row>
            <b-col md="6">
                <div class="mb-3">
                    ...
                    <flat-pickr v-model="SpaceDetails.opening_time" class="form-control" :config="config2"
                        id="startTimePicker" />
                </div>
            ...
            <b-col md="5">
                <div class="mb-3">
                    ...
                    <flat-pickr v-model="SpaceDetails.closing_time" class="form-control" :config="config2"
                        id="endTimePicker" />
                </div>
    ...
    <b-modal ref="editSpace" title="Edit Space" class="modal-fullscreen my-modal" no-close-on-backdrop no-close-on-esc
        size="xl" hide-footer>
        <b-row>
            <b-col md="12">
                <div class="mb-3">
