<template>
  <b-offcanvas v-model="show" :backdrop="false" title="" :placement="themeSchemeDirection !== 'ltr' ? 'start' : 'end'" class="live-customizer" id="live-customizer" :body-scrolling="true">
    <template #title>
      <div class="d-flex align-items-center justify-content-between">
        Live Customizer
        <div class="d-flex gap-2 align-items-center m2-3">
          <button tag="button" class="btn btn-primary px-3" data-copy="settings" data-bs-toggle="tooltip" data-bs-placement="left" title="Copy" @click="copyConfig">
          ...
          <button tag="button" @click="defaultSetting" class="btn btn-primary btn-icon" data-reset="settings" data-bs-toggle="tooltip" data-bs-placement="left" title="Reset All Retting">
            <div class="btn-inner">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.4">
                  <path
    ...
    <div class="row">
        ...
        <div class="border border-2 rounded mb-3">
          <div class="px-3 pt-3 text-center">
            ...
            <div class="p-3">
              ...
              <menu-hide v-if="isShowSetting('isSidebar')" />
              <!-- Menu hide end here -->
              ...
              <hr class="hr-horizontal" />
              <navbar-hide v-if="isShowSetting('isSidebar')" />
              <hr class="hr-horizontal" />
              ...
              <!-- Footerstyle start here-->
              <footer-style />
              <!-- Footerstyle end here -->

              <!-- Banner style start here -->
              <banner-style v-if="isShowSetting('isBanner')" />
      ...
      <b-col md="12">
        <div class="border border-2 rounded">
          <div class="px-3 pt-3 text-center d-flex align-items-center justify-content-center">
            <h5 class="d-inline-block mb-0">Advanced</h5>
            <b-badge variant="warning text-white ms-2" pill>Pro</b-badge>
          </div>
          <div class="p-3">
            <!-- App Name Start Here -->
            <adpro-app-name />
...
import CardStyle from './sections/CardStyle.vue'
import FooterStyle from './sections/FooterStyle.vue'
import MenuActiveStyle from './sections/MenuActiveStyle.vue'
import NavbarHide from './sections/NavbarHide.vue'
import NavbarStyle from './sections/NavbarStyle.vue'
import BannerStyle from './sections/BannerStyle.vue'
import MenuHide from './sections/MenuHide.vue'

//AdPro Functions
import AdproAppName from './sections/AdproAppName.vue'
import AdproFont from './sections/AdproFont.vue'
import AdproPageStyle from './sections/AdproPageStyle.vue'
import AdproStyleAppearance from './sections/AdproStyleAppearance.vue'
import AdproAnimation from './sections/AdproAnimation.vue'
import AdproStorage from './sections/AdproStorage.vue'
