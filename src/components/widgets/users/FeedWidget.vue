<template>
  <div class="card">
    <b-card-header class="d-flex align-items-center justify-content-between pb-4">
      <div class="header-title">
        <div class="d-flex flex-wrap">
          <div class="media-support-user-img me-3">
            <img class="rounded-pill img-fluid avatar-60 bg-danger-subtle p-1 ps-2" src="@/assets/images/avatars/02.png " alt="" loading="lazy" />
          </div>
      ...
      <b-dropdown class="dropdown" variant="none px-0 py-0" no-caret>
        <template #button-content>
          <span class="dropdown-toggle" id="dropdownMenuButton7" data-bs-toggle="dropdown" aria-expanded="false" role="button"> 29 mins </span>
        </template>
        <b-dropdown-item variant="none" href="javascript:void(0);">Action</b-dropdown-item>
        <b-dropdown-item variant="none" href="javascript:void(0);">Another action</b-dropdown-item>
        <b-dropdown-item variant="none" href="javascript:void(0);">Something else here</b-dropdown-item>
      </b-dropdown>
    </b-card-header>
      ...
      <div class="comment-area p-3">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
          ...
          <div class="share-block d-flex align-items-center feather-icon">
            <a href="javascript:void(0);" data-bs-toggle="offcanvas" v-b-modal.share-btn data-bs-target="#share-btn" aria-controls="share-btn">
              <span class="ms-1">
        ...
        <ul class="list-inline p-0 m-0">
          <li class="mb-2">
            <div class="d-flex">
              <img src="@/assets/images/avatars/03.png" alt="userimg" class="avatar-50 p-1 pt-2 bg-primary-subtle rounded-pill img-fluid" loading="lazy" />
              <div class="ms-3">
          ...
          <li>
            <div class="d-flex">
              <img src="@/assets/images/avatars/04.png" alt="userimg" class="avatar-50 p-1 bg-danger-subtle rounded-pill img-fluid" loading="lazy" />
              <div class="ms-3">
        ...
        <form class="comment-text d-flex align-items-center mt-3" action="javascript:void(0);">
          ...
          <div class="comment-attagement d-flex">
            ...
            <a href="javascript:void(0);" class="text-body">
              <icon-component type="outlined" icon-name="camera" :size="20" />
            </a>
          </div>
        </form>
      </div>
  ...
  <div class="card">
    <div class="card-header d-flex align-items-center justify-content-between pb-4">
      <div class="header-title">
        <div class="d-flex flex-wrap">
          <div class="media-support-user-img me-3">
            <img class="rounded-pill img-fluid avatar-60 p-1 bg-info-subtle" src="@/assets/images/avatars/05.png" alt="" loading="lazy" />
          </div>
          <div class="media-support-info mt-2">
      ...
      <b-dropdown variant="none px-0 py-0" no-caret>
        <template #button-content>
          <span class="dropdown-toggle" id="dropdownMenuButton07" data-bs-toggle="dropdown" aria-expanded="false" role="button"> 1 Hr </span>
        </template>
        <b-dropdown-item variant="none" href="javascript:void(0);">Action</b-dropdown-item>
        <b-dropdown-item variant="none" href="javascript:void(0);">Another action</b-dropdown-item>
        <b-dropdown-item variant="none" href="javascript:void(0);">Something else here</b-dropdown-item>
