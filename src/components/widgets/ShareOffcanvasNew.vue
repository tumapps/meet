<template>
  <b-offcanvas :class="`offcanvas-bottom share-offcanvas ${showoffcanvas ? 'show' : ''}`" tabindex="-1" id="share-btn" placement="bottom" aria-labelledby="shareBottomLabel" title="Share">
