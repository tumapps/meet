                ...
                <b-col md="12" lg="12">
                    <b-form-group label="Username: *" class="mb-3">
                        <b-form-input type="text" class="form-control" name="uname" placeholder="UserName"
                            ...
                            @input="updateData('username', localAccountData.username)" required />
                    </b-form-group>
                </b-col>
                <b-col md="12" lg="12">
                    <b-form-group label="Password: *" class="mb-3">
                        <b-form-input type="password" class="form-control" name="new-password" placeholder="Password"
                            ...
                            @input="updateData('password', localAccountData.password)" required />
                    </b-form-group>
                </b-col>
                <b-col md="12" lg="12">
                    <b-form-group label="Confirm Password: *" class="mb-3">
                        <b-form-input type="password" class="form-control" name="confirm-new-password"
                            placeholder="Confirm Password" v-model="localAccountData.confirm_password"
                            @input="updateData('confirm_password', localAccountData.confirm_password)" required />
                    </b-form-group>
                </b-col>
            </b-row>
        </div>
        <a href="#personal" class="btn btn-primary next action-button float-end" @click="changeTab(2)" value="Next">
            Next
        </a>
    </fieldset>
