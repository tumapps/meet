    ...
    <div class="container-fluid navbar-inner">
      ...
      <b-collapse class="navbar-collapse" id="navbarSupportedContent" @show="emit('menuOpen')" @hide="emit('menuClose')">
        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-xl-0">
          ...
          <b-dropdown class="nav-item dropdown py-0 me-2 d-flex align-items-center" variant="none px-0" no-caret dropleft>
          ...
          <li class="nav-item iq-full-screen d-none d-xl-block" id="fullscreen-item">
            <a href="#" class="nav-link" id="btnFullscreen">
              <b-button variant="primary btn-icon" pill size="sm" @click="openFullScreen">
                <span class="btn-inner">
                  <svg :class="fullScreen ? 'normal-screen d-none' : 'normal-screen'" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <svg :class="fullScreen ? 'full-normal-screen' : 'full-normal-screen d-none'" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
